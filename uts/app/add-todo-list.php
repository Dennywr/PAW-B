    ...
    <body class="text-center">
      <main class="form-signin" data-aos="zoom-in">
        <form method="POST" action="">
          <h1 class="h3 mb-3 fw-bold">ADD TO <span>DO LIST</span></h1>

          <div class="form-floating mb-2">
            <input type="text" class="form-control" id="judul-tugas" placeholder="Judul Tugas" name="judul-tugas">
            <label for="judul-tugas">Judul tugas</label>
          </div>
          <div class="form-floating">
            <textarea class="form-control" placeholder="Deskripsi Tugas" id="deskripsi-tugas" style="height: 100px" name="deskripsi-tugas"></textarea>
          ...
          <button class="btn btn-lg btn-warning btn-outline-secondary text-light mt-2" type="submit" name="submit">Create</button>
          &nbsp;&nbsp;
